...
async function testFileOperations() {
  ...
  try {
    ...
    const paths = await fileManager.createMultipleFiles(filesToCreate);
    ...
    console.log('✨ Код стал плоским, понятным и легко масштабируемым!');

  } catch (error) {
    console.error('\nПроизошла ошибка в цепочке выполнения:', error.message);
